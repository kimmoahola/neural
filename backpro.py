...
# target, error, error-rate, outside -> mode
training_sets = [
    [[5, -0.5, 0.1, 0], mode_off],
    [[7, -1.5, -0.1, -2], mode_off],
    [[5, 0, 0, -3], mode_heat8],
    [[6, 0, 0, -10], mode_heat8],
    [[5, 0.5, 0.1, -7], mode_heat10],
    [[6, 0.5, 0.1, -8], mode_heat10],
    [[5, 1, 0.1, -5], mode_heat16],
    [[8, 1, 0.1, -8], mode_heat16],
    [[12, 0, 0.1, -10], mode_heat20],
]

# # target, error, error-rate, outside -> should-heat
# training_sets = [
#     [[6, 0, 0, -10], [1]],
#     [[5, 0.5, 0.1, -7], [1]],
#     [[5, 1, 0.1, -5], [1]],
...
nn = NeuralNetwork(len(training_sets[0][0]), 6, len(training_sets[0][1]))
...
def pred(inp):
    ...
    print('predicted {} -> {} ({})'.format(inp, output_groups[predicted.index(max(predicted))], max(predicted)))
